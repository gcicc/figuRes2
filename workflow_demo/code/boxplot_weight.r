...
# Output Names: boxplot_weight.PDF
# Protocol ID: Protocol: Comp1234
# Plot Type: Boxplot
# Figure Title: Boxplot of Weight 
# table references: Table 1.1COMMA 1.2COMMA and 1.3
# Author: GC
...
incoming.df <- read.csv(paste0(dd, "g_bslchar.csv"))
