...
# Output Name: cdf_weight.PDF
# Protocol ID: Protocol: Comp1234
# Plot Type: CDF
# Figure Title: Cumulative Distribution Plot of Weight 
...
for.build <- cdf.plot(parent.df = working.df,
                      category.col = "TRTGRP",
                      ...
                      y.limits = c(0,1), seq(0,1,.1),
                      category.palette = 1:5)
